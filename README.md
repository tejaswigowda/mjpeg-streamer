...
folder:
```
cd /home/pi/image-annotate-tool/mcuFirmware/pi/mjpg-streamer/mjpg-streamer-experimental

./mjpg_streamer -o "output_http.so -w ./www" -i "input_raspicam.so -x 1920 -y 1080"
...
IMAGE: `http://pi-ip:8080/?action=snapshot`


=======
>>>>>>> 74501c146d5b51a874d245a809273ddf2380adeb
